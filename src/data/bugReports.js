...
export const disclosedReports = [
  {
    id: "gvrp-xss-gmail-inbox",
    vulnerability: "XSS in Gmail inbox",
    company: "Google",
    program: "Google VRP",
    platform: "Google Bug Hunters",
    bounty: 5000,
    severity: "high",
    url: "http://bughunters.google.com/reports/vrp/XNjex7kGr",
    publishedAt: "2026-05-01",
    tags: ["XSS", "Gmail", "Google"],
  },
  {
    id: "h1-510152",
    vulnerability: "Bypass for #488147 enables stored XSS on signin",
    company: "PayPal",
    program: "PayPal",
    platform: "HackerOne",
    bounty: 20000,
    ...
    publishedAt: "2026-05-01",
    tags: ["XSS", "Stored", "Bypass"],
  },
  {
    id: "h1-873614",
    vulnerability: "Websites can run arbitrary code on PlayStation Now",
    company: "PlayStation",
    program: "PlayStation",
    platform: "HackerOne",
    bounty: 15000,
    ...
    publishedAt: "2026-05-01",
    tags: ["RCE", "PlayStation Now", "Desktop App"],
  },
  {
    id: "h1-3556769",
